<div class="bg-white rounded grap-10 overflow-hidden shadow-card">
    <img src="{{ $book->image }}" alt="PEST Driven Laravel" class="w-full h-auto object-contain">

    <div class="px-6 pb-5">
        <div class="mt-7 flex justify-between items-center gap-4 mb-4">
        <a href="" class="text-lg-primary w-full hover:underline">{{ $book->name }}</a>
        </div>
        <div>
        <div class="flex items-center mb-2">
            <div class="flex items-center">
            {{-- <img src="https://laravel-books.com/storage/thumbnails/default/56/tp/g7t7058gcgwk00s48cwww.png?p=authors%2Fa489f89a-4866-4c10-961f-5fa6526d9709.png&amp;s=pd&amp;smartcrop=28x28" alt="Christoph Rumpel" class="w-7 h-7 object-contain flex shrink-0 rounded-full"> --}}
            </div>
            <h4 class="text-sm-primary w-full leading-5 ml-2"> {{ $book->author_name }} </h4>
        </div>
        <div class="mt-3">
