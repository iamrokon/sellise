                ...
                <div class="flex h-16 justify-between items-center">
                    ...
                    <div class="flex items-center">
                        @if (Auth::check())
                            ...
                            @if (Auth::user()->type === 1)
                                <a class="ml-8 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500" href="{{ route('dashboard') }}">Dashboard</a>
                            @else
                                <a class="ml-8 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500" href="">Submit a course</a>
                            @endif
                            <form class="ml-4" action="{{ route('logout') }}" method="POST"> @csrf
      ...
      {{-- <footer class="w-full bg-dark pt-[94px] relative">
        ...
        <div class="container flex justify-between pb-[50px]">
          ...
          <div>
            ...
            <ul class="mt-5">
              <li class="mb-2">
                <a href="{{ route('home')}}" class="text-links text-gray-100 text-base before:text-gray-100">Eloquent</a>
              </li>
              <li class="mb-2">
