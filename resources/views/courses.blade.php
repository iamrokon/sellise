        ...
        <div class="mx-auto container">
          ...
          <section aria-labelledby="courses-heading" class="pt-6 pb-12">
            ...
            <div class="flex gap-x-8 gap-y-10">
              ...
              <form class="w-3/12 block bg-white p-4 px-6 shadow rounded-sm" id="filter-courses" method="GET">
                  ...
                  <div class="pt-6">
                    <div class="space-y-2">
                      <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="text" name="search" value="@if(isset($_GET['search'])){{$_GET['search']}}@endif" class="block w-full rounded border border-gray-300 bg-white py-2 pl-10 pr-3 leading-5 placeholder-gray-500 focus:border-indigo-500 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm" placeholder="Enter keywords">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="border-b border-gray-200 py-6">
                  ...
                  <div class="pt-6">
                    <div class="space-y-2">
                      <div class="flex items-center">
                        <input  id="filter-price-free" value="free" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
